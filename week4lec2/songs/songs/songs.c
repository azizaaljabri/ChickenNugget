 ...
 *
 * @param input the line which will be split / ooo the line from the file 
 * @param delimiter the character which deliminates (splits up) the data (ooo comma in this case)
